...
<style>
    .stApp { background: linear-gradient(180deg, #FFEFBA 0%, #FFFFFF 100%); direction: $dir; text-align: $align; }
    [data-testid="stSidebar"], .stTextArea, .stTextInput, .stSelectbox, .stRadio { direction: $dir !important; text-align: $align !important; }
    .main-header { background: linear-gradient(90deg, #FF8C00 0%, #FAD02E 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-size: 3
